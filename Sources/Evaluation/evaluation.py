...
def run_clf_using_cross_validation(data, data_with_features_dict, k_fold,
    ...
    splitted_edges_dir = r'C:\Users\awannaphasch2016\PycharmProjects\recreate_gene_disease\Data\processed\LinkPrediction\GeneDiseaseProject\copd\PhenotypeGeneDisease\PGDP\Node2Vec\UnweightedEdges\NoAddedEdges\SplitByNode\KFold=101\DecendingOrder\\'
    for i, (train_test_dict) in enumerate(
        ...
        x = f'C:\\Users\\awannaphasch2016\\PycharmProjects\\recreate_gene_disease\\Data\\processed\\LinkPrediction\\GeneDiseaseProject\\copd\\PhenotypeGeneDisease\\PGDP\\Node2Vec\\UnweightedEdges\\NoAddedEdges\\SplitByNode\\KFold=101\\DecendingOrder\\{i}\\dim64_walk_len30_num_walks200_window10.txt'
        from Sources.Preparation.Features import get_instances_with_features
        data_with_features_dict[i] = get_instances_with_features(
            use_saved_emb_file=True,
            path_to_saved_emb_file=x,
